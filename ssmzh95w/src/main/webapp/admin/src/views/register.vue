  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(208, 163, 140, 0.53);borderRadius:10px">
        <h1 class="h1" style="color:rgba(255, 255, 255, 1);fontSize:28px;">校园二手交易平台的小程序注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="卖家手机" class="input" v-if="tableName=='maijia'">
			  <el-input v-model="ruleForm.maijiashouji" autocomplete="off" placeholder="卖家手机" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='maijia'" class="input-group">
			   <div class="label">邮箱</div>
			   <div class="input-container">
			...
			<el-form-item label="身份证" class="input" v-if="tableName=='maijia'">
			  <el-input v-model="ruleForm.shenfenzheng" autocomplete="off" placeholder="身份证" type="text" />
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.thumbsupnum" class="input" type="text" placeholder="赞">
			   </div>
			 </div> -->
			<el-form-item label="赞" class="input" v-if="tableName=='maijia'">
			  <el-input v-model="ruleForm.thumbsupnum" autocomplete="off" placeholder="赞" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='maijia'" class="input-group">
			   <div class="label">踩</div>
			   <div class="input-container">
			     <input v-model="ruleForm.crazilynum" class="input" type="text" placeholder="踩">
			   </div>
			 </div> -->
			<el-form-item label="踩" class="input" v-if="tableName=='maijia'">
			  <el-input v-model="ruleForm.crazilynum" autocomplete="off" placeholder="踩" type="text" />
			</el-form-item>
