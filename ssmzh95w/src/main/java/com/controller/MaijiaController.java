...
public class MaijiaController {
    ...
    public R info(@PathVariable("id") Long id){
		...
		maijia.setClicknum(maijia.getClicknum()+1);
		maijia.setClicktime(new Date());
		maijiaService.updateById(maijia);
    ...
    public R thumbsup(@PathVariable("id") String id,String type){
        MaijiaEntity maijia = maijiaService.selectById(id);
        if(type.equals("1")) {
        	maijia.setThumbsupnum(maijia.getThumbsupnum()+1);
        } else {
        	maijia.setCrazilynum(maijia.getCrazilynum()+1);
        }
        maijiaService.updateById(maijia);
        return R.ok();
    }
    ...
    public R autoSort(@RequestParam Map<String, Object> params,MaijiaEntity maijia, HttpServletRequest request,String pre){
        EntityWrapper<MaijiaEntity> ew = new EntityWrapper<MaijiaEntity>();
